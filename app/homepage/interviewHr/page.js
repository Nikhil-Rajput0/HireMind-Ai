...
export const metadata = {
  title: `HireMind Ai | Hr Interview`,
  ...
  return (
    <section>
      <div>
        ...
        <div className="mb-[70vh] relative flex items-center justify-between px-13 py-2 mt-5 bg-slate-100 border border-slate-200 shadow-xl font-medium text-slate-900">
          ...
          <div className="flex items-center gap-3">
            ...
            <button className="bg-red-500 px-3 text-gray-100 cursor-pointer py-2 flex items-center rounded-full ">
              Delete
            </button>
          </div>
        </div>
