...
export default function Page() {
  return (
    <section className="bg-[#ecebeb] pb-20">
      ...
      <main className="px-40 pt-10">
        <div className="flex flex-col gap-2">
          <h2 className="text-3xl font-bold">HireMind Ai Privacy Notice</h2>
        ...
        <div className="flex flex-col gap-3">
          <div className="flex flex-col gap-3">
            <p className="text-2xl font-bold">1. Introduction</p>
          ...
          <div className="flex flex-col gap-3">
            <p className="text-2xl font-bold">2. Information We Collect</p>
            <div className="text-[15px] text-gray-900 flex flex-col gap-1">
              ...
              <ul className="pl-7 text-[16px] list-disc list-inside">
                <li> Name</li>
                <li>Email Address</li>
                <li>Account credentials </li>
              </ul>
              <p className="text-[16px] font-bold">🔹 Usage Data</p>
              <ul className="pl-7 text-[16px] list-disc list-inside">
                <li>Pages Visited</li>
                <li>Features used (interviews, resume tools)</li>
                <li>Interaction with AI features </li>
              </ul>
              <p className="text-[16px] font-bold">🔹 Uploaded Content </p>
              <ul className="pl-7 text-[16px] list-disc list-inside">
                <li>Resumes</li>
          ...
          <div className="flex flex-col gap-3">
            <p className="text-2xl font-bold">3. How We Use Your Information</p>
          ...
          <div className="flex flex-col gap-3">
            <p className="text-2xl font-bold">4. Data Security</p>
          ...
          <div className="flex flex-col gap-3">
            <p className="text-2xl font-bold">5. Data Sharing</p>
            <div className="text-[16px] text-gray-900 flex flex-col gap-1">
          ...
          <div className="flex flex-col gap-3">
            <p className="text-2xl font-bold">6. Cookies</p>
            <div className="text-[16px] text-gray-900 flex flex-col gap-1">
          ...
          <div className="flex flex-col gap-3">
            <p className="text-2xl font-bold">7. Third-Party Services</p>
            <p className="text-[16px] text-gray-900">
          ...
          <div className="flex flex-col gap-3">
            <p className="text-2xl font-bold">8. Your Rights</p>
            <div className="text-[16px] text-gray-900 flex flex-col gap-1">
          ...
          <div className="flex flex-col gap-3">
            <p className="text-2xl font-bold">9. Changes to This Policy</p>
            <p className="text-[16px] text-gray-900">
          ...
          <div className="flex flex-col gap-3">
            <p className="text-2xl font-bold">10. Contact Us</p>
            <div className="text-[16px] text-gray-900 flex flex-col gap-1">
